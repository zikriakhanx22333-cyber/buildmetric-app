...
import { convertLength } from '../../utils/calculatorLogic';
import { Copy, Check, Printer, RotateCcw, Ruler } from 'lucide-react';
...
export const LengthConverter: React.FC = () => {
  ...
  const results: UnitConverterResults = convertLength(inputs);
  ...
  const handleCopy = () => {
    const text = `
BuildMetric - Construction Length Unit Conversion:
------------------------------------------------
    ...
    <div className="space-y-6">
      <div className="bg-[#0F2D5C] text-white p-6 rounded-2xl shadow-md border-b-4 border-[#F4B400]">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h2 className="text-2xl font-bold">Construction Length Unit Converter</h2>
            <p className="text-blue-100 text-sm">Convert between meters, feet, inches, yards, and millimeters</p>
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-6 bg-slate-900 text-white p-6 rounded-2xl shadow-lg border border-slate-800 flex flex-col justify-between">
          <div>
            ...
            <div className="my-6 p-6 bg-[#0F2D5C] rounded-2xl border border-blue-900/60 text-center">
              <div className="text-xs text-blue-200 uppercase font-bold tracking-wider">Converted Length</div>
