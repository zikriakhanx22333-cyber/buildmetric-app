...
import { convertVolume } from '../../utils/calculatorLogic';
import { Copy, Check, Printer, RotateCcw, Box } from 'lucide-react';
...
export const VolumeConverter: React.FC = () => {
  ...
  const results: UnitConverterResults = convertVolume(inputs);
  ...
  const handleCopy = () => {
    const text = `
BuildMetric - Construction Volume Unit Conversion:
------------------------------------------------
    ...
    <div className="space-y-6">
      <div className="bg-[#0F2D5C] text-white p-6 rounded-2xl shadow-md border-b-4 border-[#F4B400]">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h2 className="text-2xl font-bold">Construction Volume Unit Converter</h2>
            <p className="text-blue-100 text-sm">Convert between Cubic Feet (CFT), Cubic Meters (m³), Cubic Yards, and Liters</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              >
                ...
                <option value="cum">Cubic Meters (m³)</option>
        ...
        <div className="lg:col-span-6 bg-slate-900 text-white p-6 rounded-2xl shadow-lg border border-slate-800 flex flex-col justify-between">
          <div>
            ...
            <div className="my-6 p-6 bg-[#0F2D5C] rounded-2xl border border-blue-900/60 text-center">
              <div className="text-xs text-blue-200 uppercase font-bold tracking-wider">Converted Volume</div>
